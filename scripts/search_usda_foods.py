...
Examples:
  ...
  python search_usda_foods.py "banana" --csv data/usda_all_foods_macros.csv
    ...
    parser.add_argument(
        'query',
        help='Search term to look for in food names'
    )
    ...
    parser.add_argument(
        '--type',
        choices=['sr_legacy_food', 'foundation_food', 'branded_food', 'survey_fndds_food'],
    ...
    if not csv_path.exists():
        ...
        print(f"  python scripts/extract_usda_csv_macros.py FoodData_Central_csv_2025-04-24/")
        sys.exit(1)
